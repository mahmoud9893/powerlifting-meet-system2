<template>
  <div class="organizer-view p-6 bg-gray-100 min-h-screen">
    ...
    <div class="mb-8 rounded-lg bg-white p-6 shadow-md">
      ...
      <div v-else class="italic text-gray-600">No lift currently active.</div>
    </div>
    ...
    <div class="mb-8 rounded-lg bg-white p-6 shadow-md">
              ...
              <td class="border-b border-gray-200 px-6 py-4">
                ...
                <div class="mt-1 flex flex-wrap">
                  <span
                    ...
                    :key="wcName"
                    class="badge-class mr-1 mb-1 bg-blue-200 text-blue-800"
                  >
                    {{ wcName }}
                    <button
              ...
              <td class="border-b border-gray-200 px-6 py-4">
                ...
                <div class="mt-1 flex flex-wrap">
                  <span
                    ...
                    :key="acName"
                    class="badge-class mr-1 mb-1 bg-purple-200 text-purple-800"
                  >
                    {{ acName }}
                    <button
      ...
      <div v-else class="italic text-gray-600">No lifters registered.</div>
    </div>
      ...
      <div class="mb-6 rounded-md border bg-gray-50 p-4">
        ...
        >
          ...
          <input
            ...
            type="number"
          />
          <select v-model="newWeightClass.gender" class="form-select" required>
            <option value="" disabled>Select Gender</option>
            <option value="Male">Male</option>
            <option value="Female">Female</option>
